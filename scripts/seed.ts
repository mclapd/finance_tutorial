...
const SEED_USER_ID = "user_2gUHZDIawYFXqtBlSlkx7toI8Fe";
const SEED_CATEGORIES = [
  ...
  // { id: "category_4", name: "Food", userId: SEED_USER_ID, plaidId: null },
  // {
  //   id: "category_5",
  //   name: "Transportation",
  //   userId: SEED_USER_ID,
  ...
  // { id: "category_8", name: "Clothing", userId: SEED_USER_ID, plaidId: null },
  // {
  //   id: "category_9",
  //   name: "Miscellaneous",
  //   userId: SEED_USER_ID,
